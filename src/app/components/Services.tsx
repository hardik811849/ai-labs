...
// import grad from "../././../public/Component 92.svg";
  ...
  return (
    <div className="w-full">
      <div className="w-full flex flex-col justify-center items-center text-center mb-[100px]">
        ...
        <p className="text-zinc-500 text-[30px]  w-3/5">
      ...
      <div className="mx-auto w-[80%] grid grid-cols-3 gap-8 justify-center items-center">
        <div className="p-[30px] bg-transparent rounded-xl text-[16px] services-button">
          <div className="p-[10px] pl-[15px] pr-[15px] w-fit rounded-lg bg-gradient-to-r from-[#6430fb] to-[#b596fd] mb-[30px]">
            <Image src={services6} alt="service-1" width={50} height={50} />
          </div>
          {/* <div className="gradient-image w-[26.85rem] h-[14.5rem]"></div> */}
          <div className="top-gradient-image-top">
            <p className="mb-[22px] text-[28px]">Mobile App Development</p>
            <p className="mb-[30px] text-[18px] text-zinc-500 ">
      ...
      <div className="mx-auto w-[80%] font-inter mb-[100px]">
        <div className="achievement flex justify-between items-center">
          <div className="text-gradient text-[23px] w-[100px]">
            See our Achievement
          </div>
          <hr className="border-none h-[2px] hr-gradient" />
          <div>
            <p className="text-[60px]">89 %</p>
            <p className="text-zinc-500">Accuracy in Data</p>
          </div>{" "}
          <hr className="border-none h-[2px] hr-gradient" />
          <div>
            <p className="text-[60px]">5M+</p>
            <p className="text-zinc-500">Global Users</p>
          </div>{" "}
          <hr className="border-none h-[2px] hr-gradient" />
          <div>
            <p className="text-[60px]">2M+</p>
            <p className="text-zinc-500">Accuracy in Data</p>
          </div>{" "}
        </div>
